  ...
  return (
    <div className="blog-container">
      ...
      <div>
        ...
        <p>
          <small>উত্তর:Authentication হোল ব্যবহারকারীরা যাকে তারা দাবি করে তা যাচাই
        ...
        <p>
          <small>উত্তরঃ Firebase যে কারনে ব্যাবহার করা উচিত তা হোল-- Firebase হচ্ছে
          ...
          শুধুমাত্র একবার সদস্যতা নিতে হবে।</small>
        </p>
        <br />
        <h6>What other services does firebase provide other than authenticat</h6>
        <p><small>উত্তর ঃ Firestore database load করা যায় । Realtime database load করা যায় । এর ভিতরে storage অ রয়েছে । Hosting করা যায়। এবং আর অনেক কিছু </small></p>
      </div>
    </div>
  );
};
